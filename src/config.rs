...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            device_index: 0,
            gain: 1.0,
            smoothing: SmoothingPreset::Normal,
...
pub unsafe fn register_settings(api: &MsgPluginAPI, endpoint_id: u32) {
    ...
    let defs = [
        ...
        make_int_setting(
            c"Smoothing",
            c"Smoothing",
            c"Stable kills every tremor (a touch of lag), Normal is the field-tested default, Reactive follows fast moves closest",
            0,
            2,
            SmoothingPreset::Normal.to_i32(),
